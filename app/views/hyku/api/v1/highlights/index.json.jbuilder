...
if @collections.present?
  json.explore_collections do
    json.partial! 'hyku/api/v1/collection/collection', collection: @collections, as: :collection
  end
else
...
if @featured_works.present?
  json.featured_works do
    json.partial! 'hyku/api/v1/work/work', collection: @featured_works, as: :work
  end
else
...
if @recent_documents.present?
  json.recent_works do
    json.partial! 'hyku/api/v1/work/work', collection: @recent_documents, as: :work
  end
else
