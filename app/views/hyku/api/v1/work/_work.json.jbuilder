...
json.cache! [@account, :works, work.id, work.solr_document[:_version_],
  ...
  json.files do
    if work&.file_set_presenters
      ...
      json.has_private_files work.file_set_presenters.any? { |fsp| fsp.wrapper_for_solr_document.private? }
      json.has_registered_files work.file_set_presenters.any? { |fsp| fsp.wrapper_for_solr_document.registered? }
      json.has_public_files work.file_set_presenters.any? { |fsp| fsp.wrapper_for_solr_document.public? }
    else
  ...
  if work.representative_presenter&.wrapper_for_solr_document.public?
