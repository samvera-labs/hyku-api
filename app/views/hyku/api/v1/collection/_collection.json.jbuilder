...
json.cache! [@account, :collections, collection.id, collection.solr_document[:_version_]] do
  ...
  json.total_parent_collections @total_parent_collections
  json.parent_collections @available_parent_collections
end
...
if local_assigns[:include_collections]
  json.collections do
    json.partial! 'hyku/api/v1/collection/collection', collection: @child_collections, as: :child_collection, collection_docs: Array.wrap(@collection_sub_collection_search_results)
  end
end